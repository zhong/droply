const translations = {
  zh: {
    ...
    "qs.title": "快速开始",
    "qs.sub": "几分钟即可上手。",
    "qs.download": "从 Release 下载",
    "qs.download_desc": "预编译二进制文件，支持 <strong>macOS</strong>（ARM/x64）、<strong>Linux</strong>（x64）和 <strong>Windows</strong>（x64）。查看<a href=\"https://github.com/zhong/droply/releases/latest\">所有下载</a>。",
    "qs.build": "从源码编译",
